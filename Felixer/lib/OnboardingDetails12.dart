...
class OnboardingDetails12 extends StatelessWidget {
  OnboardingDetails12({
    Key key,
  }) : super(key: key);
  @override
          ...
          Transform.translate(
            ...
            child:
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(212.8, 464.0, 479.8, 479.8),
                    size: Size(877.4, 1254.2),
                    fixedWidth: true,
                    fixedHeight: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(187.0, 18.4, 690.4, 1235.9),
                    size: Size(877.4, 1254.2),
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(0.0, 0.0, 659.9, 915.4),
                    size: Size(877.4, 1254.2),
                    pinLeft: true,
                    pinTop: true,
                    fixedWidth: true,
          ...
          Transform.translate(
            ...
            child: SizedBox(
              ...
              child: Stack(
                children: <Widget>[
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(17.0, 0.0, 11.0, 11.0),
                    size: Size(45.0, 11.0),
                    pinTop: true,
                    pinBottom: true,
                    fixedWidth: true,
                  ...
                  Pinned.fromSize(
                    bounds: Rect.fromLTWH(34.0, 0.0, 11.0, 11.0),
                    size: Size(45.0, 11.0),
                    pinRight: true,
                    pinTop: true,
                    pinBottom: true,
